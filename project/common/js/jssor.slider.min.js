...
! function (i, h, m, f, d, k, e) {
    ...
    i.$JssorBulletNavigator$ = function () {
        ...
        function y(a) {            
            if (document.getElementById("slides").children[a].children[0].localName=="video") {
                document.getElementById("slides").children[a].children[0].pause();
            }
            if (this.val != a) {
                this.val=a;
                if (document.getElementById("slides").children[a].children[0].localName=="video") {
                    document.getElementById("slides").children[a].children[0].play();
                }
            }
